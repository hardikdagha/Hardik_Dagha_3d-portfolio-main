# Hardik Dagha 3D Portfolio

This repository contains the source code for a cybersecurity-focused 3D portfolio built with React, TypeScript, Three.js, React Three Fiber, and GSAP. It combines animated sections, a 3D character scene, custom cursor interactions, and scroll-driven transitions tailored around Hardik Dagha's security operations profile.
...
You can further adapt this portfolio by updating the following areas:
...
For static/shared hosting that serves files from a document root, upload the contents of `dist/` so these paths exist on the server root:
